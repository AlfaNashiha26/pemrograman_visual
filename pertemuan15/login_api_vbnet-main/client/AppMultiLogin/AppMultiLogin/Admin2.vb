...
Public Class Admin2
    Private Sub TambahData()
        ...
        Dim payment As String = txtPay.Text

        Dim postData As String = $"kode={kode}&nama={nama}&harga={harga}&payment={payment}"
    ...
    Private Sub UpdateData()
        ...
        Try
            ...
            Dim responseBytes As Byte() = client.UploadData(penjualan_api & "?kode=" & txtKode.Text, "PUT", byteArray)
    ...
    Private Sub DeleteData()
        ...
        Try
            ...
            ' Send the PUT request and get the response
            Dim responseBytes As Byte() = client.UploadData(penjualan_api & "?kode=" & txtKode.Text, "DELETE", byteArray)
    ...
    Private Sub GetData()
        Using client As New HttpClient()
            ...
            Dim response As HttpResponseMessage = client.GetAsync(penjualan_api & "?kode=" & txtKode.Text).Result
