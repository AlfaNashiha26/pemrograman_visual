...
Partial Class Form1
    ...
    Private Sub InitializeComponent()
        ...
        ' txtFahrenheit
        ' 
        txtFahrenheit.Font = New Font("Microsoft Sans Serif", 12.0F, FontStyle.Bold, GraphicsUnit.Point)
        txtFahrenheit.Location = New Point(155, 69)
        txtFahrenheit.Margin = New Padding(3, 4, 3, 4)
        txtFahrenheit.Name = "txtFahrenheit"
        txtFahrenheit.Size = New Size(146, 30)
        ...
        txtReamur.Location = New Point(155, 244)
        ...
        txtKelvin.Location = New Point(155, 311)
        ...
        Name = "Form1"
        Text = "Fahrenheit Converter - Alfa Nashiha"
        ResumeLayout(False)
        PerformLayout()
    End Sub
