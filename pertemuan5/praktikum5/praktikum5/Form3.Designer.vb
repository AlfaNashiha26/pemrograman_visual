...
Partial Class Form3
    ...
    Private Sub InitializeComponent()
        ...
        Label1.TabIndex = 0
        Label1.Text = "Kode Universitas"
        ' 
        ' txtKodeUniv
        ' 
        txtKodeUniv.Font = New Font("Microsoft Sans Serif", 9.0F, FontStyle.Regular, GraphicsUnit.Point)
        txtKodeUniv.Location = New Point(32, 51)
        txtKodeUniv.Margin = New Padding(3, 4, 3, 4)
        txtKodeUniv.Name = "txtKodeUniv"
        txtKodeUniv.Size = New Size(142, 24)
        txtKodeUniv.TabIndex = 1
        ' 
        ' txtKeterangan
        ' 
        ...
        Controls.Add(Label2)
        Controls.Add(txtKodeUniv)
        Controls.Add(Label1)
        Margin = New Padding(3, 4, 3, 4)
        Name = "Form3"
        Text = "Nama Universitas Muhammadiyah"
        ResumeLayout(False)
        PerformLayout()
    End Sub

    Friend WithEvents Label1 As Label
    Friend WithEvents txtKodeUniv As TextBox
