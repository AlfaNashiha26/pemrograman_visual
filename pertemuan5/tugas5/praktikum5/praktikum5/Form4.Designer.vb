...
Partial Class Form4
    ...
    Private Sub InitializeComponent()
        ...
        Label1.TabIndex = 0
        Label1.Text = "Kode Spesies"
        ' 
        ' txtKodeSpesies
        ' 
        txtKodeSpesies.Font = New Font("Microsoft Sans Serif", 9.0F, FontStyle.Regular, GraphicsUnit.Point)
        txtKodeSpesies.Location = New Point(32, 51)
        txtKodeSpesies.Margin = New Padding(3, 4, 3, 4)
        txtKodeSpesies.Name = "txtKodeSpesies"
        txtKodeSpesies.Size = New Size(142, 24)
        txtKodeSpesies.TabIndex = 1
        ' 
        ' txtKeterangan
        ' 
        ...
        Controls.Add(Label2)
        Controls.Add(txtKodeSpesies)
        Controls.Add(Label1)
        Margin = New Padding(3, 4, 3, 4)
        Name = "Form4"
        Text = "Nama Spesies Hewan"
        ResumeLayout(False)
        PerformLayout()
    End Sub

    Friend WithEvents Label1 As Label
    Friend WithEvents txtKodeSpesies As TextBox
