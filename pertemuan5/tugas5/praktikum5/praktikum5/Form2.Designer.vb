...
Partial Class Form2
    ...
    Private Sub InitializeComponent()
        ...
        ' txtNoVoucher
        ' 
        txtNoVoucher.Font = New Font("Microsoft Sans Serif", 9.0F, FontStyle.Regular, GraphicsUnit.Point)
        txtNoVoucher.Location = New Point(32, 51)
        txtNoVoucher.Margin = New Padding(3, 4, 3, 4)
        txtNoVoucher.Name = "txtNoVoucher"
        txtNoVoucher.Size = New Size(142, 24)
        txtNoVoucher.TabIndex = 1
        ' 
        ' txtKeterangan
        ' 
        ...
        Controls.Add(Label2)
        Controls.Add(txtNoVoucher)
        Controls.Add(Label1)
        Margin = New Padding(3, 4, 3, 4)
        Name = "Form2"
        Text = "Voucher Makanan Karyawan"
        ResumeLayout(False)
        PerformLayout()
    End Sub

    Friend WithEvents Label1 As Label
    Friend WithEvents txtNoVoucher As TextBox
