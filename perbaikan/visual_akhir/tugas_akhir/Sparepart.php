...
class Sparepart 
{
    ...
    {
        $query = "INSERT INTO $this->table (`kode`,`nama`,`harga`,`stok`) VALUES ('$this->kode','$this->nama','$this->harga','$this->stok')";
        $this->db->query($query);
        return $this->db->insert_id();
    }
    public function update(int $id): int
    {
        $query = "UPDATE $this->table SET kode = '$this->kode', nama = '$this->nama', harga = '$this->harga', stok = '$this->stok' 
        WHERE id = $id";
        $this->db->query($query);
