...
Public Class Admin1
    Private Sub TambahData()
        ...
        Dim postData As String = $"kode={kode}&nama={nama}&harga={harga}&stok={stok}"
    ...
    Private Sub UpdateData()
        ...
        Try
            ...
            Dim responseBytes As Byte() = client.UploadData(sparepart_api & "?kode=" & txtKode.Text, "PUT", byteArray)
    ...
    Private Sub DeleteData()
        ...
        Try
            ...
            ' Send the PUT request and get the response
            Dim responseBytes As Byte() = client.UploadData(sparepart_api & "?kode=" & txtKode.Text, "DELETE", byteArray)
    ...
    Private Sub GetData()
        Using client As New HttpClient()
            ...
            Dim response As HttpResponseMessage = client.GetAsync(sparepart_api & "?kode=" & txtKode.Text).Result
